...
/**
 * Route wrapper for public auth pages (/login, /register, /forgot-password, /reset-password).
 * If user is already authenticated, redirects them away to /dashboard.
 * If authentication state is initializing, shows loading splash.
 */
